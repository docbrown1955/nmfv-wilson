        ...
        )
{
    ...
    const complex_t IT_0039 = (complex_t{0, (-0.03125)})*m_mu*IT_0000*IT_0010*
      ...
      *IT_0000*IT_0010*(IT_0021 + IT_0025 + -IT_0028 + -IT_0031) + (complex_t{0,
       (-0.03125)})*m_mu*IT_0000*IT_0010*(IT_0021 + -IT_0028 + -IT_0031 + 
      -IT_0033 + IT_0035 + IT_0038) + (complex_t{0, 0.03125})*m_mu*IT_0000
      *IT_0010*(IT_0021 + IT_0028 + -IT_0031 + -IT_0033 + -IT_0035 + -IT_0038);
    return IT_0039;
}
